...
[installation](/developer-resources/tools/s3) page.
...
public key. This is optional, as described in the [bucket usage](/developer-resources/tools/s3#create-an-aliased-bucket)
