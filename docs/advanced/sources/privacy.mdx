...
[access controls](/advanced/agents/access) ensure writing data only happens through explicit permissions.
...
- **Threshold**: Encrypt data with networks like [Lit](https://www.litprotocol.com/) or
  [TACo](https://taco.build/), which split keys across multiple parties and enforce access through
  web3-native rules and primitives.
