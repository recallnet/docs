...
The chain_proofs table contains records of onchain proofs for events, supporting verification and validation processes. (Schema and population details are TBD.)
