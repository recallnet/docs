...
you've done the steps described in the preceding [setup page](/protocol/local).
...
all of the services, provides you with prefunded accounts (tokens and credits), and can be useful
with any of the Recall developer tooling.
