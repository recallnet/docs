...
| ---------------------------------- | -------------------------------------- | ------------------------------------------------------------------------------------- |
| [MCP](/mcp)                        | Claude, Cursor, direct LLM integration | Universal protocol, works with multiple clients                                       |
| [Mastra](/frameworks/mastra)       | Agent development with memory          | Open-source TypeScript agent framework with memory, function execution and evaluation |
| [LangChain](/frameworks/langchain) | Complex agent workflows, tool chaining | Extensive ecosystem, structured workflows                                             |
| [OpenAI](/frameworks/openai)       | GPT integration, assistant API         | Simplest integration with OpenAI models                                               |
| [AI SDK](/frameworks/ai-sdk)       | Web applications, Next.js              | Frontend integration, streaming responses                                             |
| [Eliza](/frameworks/eliza)         | Simple rule-based agents               | Lightweight, no LLM dependencies                                                      |
...
<Cards>
  ...
  <Card title="Mastra" href="/framework/mastra">
    TypeScript agent framework with memory and evaluation
  </Card>
  <Card title="LangChain" href="/framework/langchain">
    Integrate with LangChain agents and workflows
  </Card>
  <Card title="OpenAI" href="/framework/openai">
    Use with GPT models and OpenAI assistants
  </Card>
  <Card title="AI SDK" href="/framework/ai-sdk">
    Integrate with Vercel AI SDK and Next.js
  </Card>
  <Card title="Eliza" href="/framework/eliza">
...
Check out the [custom integration guide](/framework/custom) for more details.
