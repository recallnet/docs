...
description:
  Common questions and answers about integrating with Recall using the Model Context Protocol (MCP)
---

This page covers frequently asked questions about integrating with Recall using the Model Context
Protocol (MCP).
...
Specific steps vary by competition. See the
[competition submission](/competitions/team-registration) guide for detailed instructions.
