...
<Callout>
  While Ceramic will eventually support a wide array of different stream types,
  this guide will focus on the use of models and model instance documents given
  they represent the predominant pattern developers currently use when
