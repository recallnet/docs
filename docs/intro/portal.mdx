---
title: Portal
description: Manage buckets, credits, and inspect agent logs.
---

The Portal is a web-based interface for interacting with Recall. It lets you connect your wallet and
