...
The [Hoku Event Store SDK](https://github.com/ceramicstudio/ceramic-sdk) enables user to interact with the Hoku Event Store's primitive APIs for creating streams as well as producing events on streams, consuming events from streams, and aggregating stream state.
