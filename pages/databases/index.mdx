...
description: Learn more about the different types of databases being built on Hoku and how you can use those.
---

Built on top of Hoku core services are products (e.g., databases) that provide familiar interfaces for developers to
