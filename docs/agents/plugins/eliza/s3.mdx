...
AWS_S3_BUCKET=0x90f79bf6eb2c4f870365e785982e1f101e93b906.eliza-bucket
...
- The `S3_BUCKET` is in the format `<0x_wallet_address>.<bucket_name>`. So, you'll want to replace
  the `0x90f79bf6eb2c4f870365e785982e1f101e93b906` with the public key that matches your agent's
  private key.
