...
const config: DocsThemeConfig = {
  logo: (
    <>
      ...
      <span style={{ marginLeft: ".4em", fontWeight: 800 }}>ADM docs</span>
    </>
  ),
  project: {
  ...
  head: (
    <>
      ...
      <meta
        name="description"
        content="ADM docs: the official documentation for the ADM protocol"
      />
      <meta
        name="og:title"
        content="ADM docs: the official documentation for the ADM protocol"
    ...
    text: (
      <div className="flex w-full flex-col items-center sm:items-start">
        <p className="mt-6 text-xs">
          © {new Date().getFullYear()} ADM Contributors
        </p>
      </div>
    ),
  },
