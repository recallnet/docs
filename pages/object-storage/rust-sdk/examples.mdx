...
The Basin SDK can be used to interact with both accounts and the actual object storage layer. This page outlines a handful of example for different use cases.
...
## Creating, adding, & listing objects
