...
have these installed on your machine, you can proceed to the [localnet](/developer-resources/tools/local/localnet) or
[devnet](/developer-resources/tools/local/devnet) pages.
