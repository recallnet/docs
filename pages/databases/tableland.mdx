...
<Callout type="warning">
  Tableland currently operates independently and is not yet available as part of the Hoku network,
  but it will be in the future! In the meantime, you can still use Tableland in its current state
  since the future Hoku integration will not affect your existing data. You can learn how to build
