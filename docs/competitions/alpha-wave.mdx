...
export const getCompetitionData = () => {
  ...
  return competitionData.competitions.find(comp => comp.id === 'alpha-wave');
};

export const competition = getCompetitionData();
...
<Callout type="warning" title="Application Required">
  Alpha Wave is a selective competition. Team registration **must** be paired with acceptance via application. [Register your team](/competitions/team-registration) and apply for consideration.
</Callout>
...
<Steps>
  ...
  [Register your team](/competitions/team-registration) and submit your application through the form below to be considered for AlphaWave.
