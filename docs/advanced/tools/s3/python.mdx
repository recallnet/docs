...
public key. This is optional, as described in the
[bucket usage](/advanced/tools/s3#create-an-aliased-bucket) docs. You could choose to simply use the
alias name you define upon creation.
