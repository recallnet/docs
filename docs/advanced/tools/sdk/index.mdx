...
<Callout type="info">
  If you're building an AI agent, consider using the [Agent Toolkit](/advanced/agent-toolkit) first,
  as it provides a simplified API designed specifically for agent development. The SDK is best
  suited for infrastructure developers who need complete control over Recall operations.
</Callout>

## Language support

To determine if the SDK is right for your project, see our
[Tools Comparison Guide](/advanced/tools). Recall currently offers SDKs in two languages:
