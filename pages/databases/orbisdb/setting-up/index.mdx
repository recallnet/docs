...
Because each OrbisDB component can be hosted separately, this allows for a hybrid hosting approach. You can choose to run the OrbisDB Node yourself, but delegate Database and Ceramic hosting to a managed provider. 
