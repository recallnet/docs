...
The [Ceramic SDK](https://github.com/ceramicstudio/ceramic-sdk) enables user to interact with the Ceramic's primitive APIs for creating streams as well as producing events on streams, consuming events from streams, and aggregating stream state. Find it on GitHub at https://github.com/ceramicstudio/ceramic-sdk.
...
The Ceramic SDK needs a [ceramic-one](https://github.com/ceramicnetwork/rust-ceramic) daemon to connect to.
