...
The core contracts manage subnet creation, bridging, validator entrance, and all activities related
to the core maintaining consensus over state (checkpointing, etc).
...
The supply source for a subnet provides funds that get deposited (bridged) from the parent chain
into the subnet, and withdrawals are supported as well.
