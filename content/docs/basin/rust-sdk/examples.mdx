---
title: Examples
description: A series of Recall SDK examples.
---
...
async fn main() -> anyhow::Result<()> {
    ...
    // Deposit some RECALL (Calibration) funds into the subnet
...
use recall_sdk::machine::bucket::{AddOptions, Bucket, GetOptions, QueryOptions};
