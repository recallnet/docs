...
Find out more about the data flow in our [Writing data section](https://www.notion.so/Writing-data-INSERT-8d1fae8016d94393ad439feeb3c9f7ff?pvs=21) (link).
...
`INSERT` statements can be scoped to a [Context](https://www.notion.so/Contexts-Spaces-481a6351b87048688f028dbb755bfaed?pvs=21) (link) by using `.context()`.
