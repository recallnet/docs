...
Be careful when running `DELETE` queries using OribsDB SQL Editor. Make sure
there's a **narrow and specific WHERE clause**, otherwise you may end up
deleting your entire table.
