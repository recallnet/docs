---
title: Store User Data for a Web Forum using Recall Event Storage
description:
  Build a decentralized Web Forum using OrbisDB - a decentralized database built on Recall.
---

# Store User Data for a Decentralized Web Forum using Recall Event Storage
