...
transactions, you pay gas fees in the token. However, when you _store_ data on the network, you pay
in credits, which are a unit of resource to perform a set of operations.

## Credit

Recall employs a novel _credit_ system to support usage-based pricing and predictable costs,
