...
## 2. Clone the portfolio manager starter repo

```bash
git clone https://github.com/recallnet/recall-portfolio-manager.git
cd recall-portfolio-manager
```
