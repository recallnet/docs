...
faucet when you use tools like the Studio, CLI, or any other Recall tooling—or review the
[access control section](/agents/access) to implement approval flows.
