...
Check out our [Querying data](https://www.notion.so/Querying-data-SELECT-869d600cf7d04ae58d0b1c4821b1d35e?pvs=21) (link) to find out more.
...
Only `SELECT` statements built using the query builder can be scoped to a [Context](https://www.notion.so/Contexts-Spaces-481a6351b87048688f028dbb755bfaed?pvs=21) (link) by using `.context()`.\
