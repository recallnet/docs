...
and buckets. To learn more about these concepts, check out the [data sources](/advanced/sources)
pages, which walk through creating buckets or reading/writing data.
