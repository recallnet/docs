...
OrbisDB utilizes [DIDs](/databases/orbisdb-managing-data/accounts) for its account management. We
managed to abstract all the complexities away and bundle it into a single method call.
