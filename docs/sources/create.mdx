...
Any of the core [developer tools](/developer-resources/tools/cli) can be used to create buckets, write to them, and read
...
[S3 adapter](/developer-resources/tools/s3) or agent tools, and the `--alias` flag is shorthand for the
...
how to set it up, see the [access and collaboration docs](/agents/access).
