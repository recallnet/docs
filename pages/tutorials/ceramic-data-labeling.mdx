...
description:
  Create a labeled dataset for LLM training using OrbisDB - a decentralized database built on Hoku.
---
...
characteristics might benefit ML pipeline architects. This is where Hoku’s Event Storage
capabilities come into play.

## Hoku Event Storage for Data Labeling

Hoku’s Event Storage capabilities feature Ceramic - a decentralized data network built on verifiable
event streams on top of which relational databases, private storage, and event-driven capabilities
can be built. A key characteristic of Ceramic is its verifiable data integrity and lineage. Here’s
how this relates to data labeling:
...
example of how to facilitate data labeling into Hoku Event Storage.
...
Hoku Event Storage, there are many other places within the LLM pipeline where Ceramic could be
...
Are you interested in leveraging Hoku for your data labeling needs? Did you find this guide helpful?
