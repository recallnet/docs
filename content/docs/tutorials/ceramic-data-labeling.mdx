---
title: Label Data for LLM training using Recall Event Storage
description:
  Create a labeled dataset for LLM training using OrbisDB - a decentralized database built on
  Recall.
---

# Label Data for LLM training using Recall Event Storage
