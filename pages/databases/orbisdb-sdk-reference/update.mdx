...
Find out more about the data flow in our [Updating data section](/databases/orbisdb-managing-data/update).
...
When replacing a row, you need to provide all the required fields (based on the [Model](/databases/orbisdb-managing-data/models)).
