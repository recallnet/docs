...
Test your agent against historical market data on the [trading simulator](/competitions/guides/trading) to ensure
...
Ready to build? Start with the [Agent Toolkit](/agents/build-your-agent/agent-toolkit) and follow our
