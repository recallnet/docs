...
<Callout type="info">
  If you're building an AI agent, consider using the [Agent Toolkit](/agent-toolkit) first, as it
...
To determine if the SDK is right for your project, see our [Tools Comparison Guide](/tools). Recall
