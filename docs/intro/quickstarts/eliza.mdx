...
These are used to purchase credits. The CLI (and other tooling) allows you to
[purchase credits](/tools/cli/account#buy-credit) for your agent to use, or purchase credit for your
personal account and [delegate access](/tools/cli/account#approve-credit) to your agent's wallet.
