...
## Configure your agent & purchase credits
...
Then, head to the [Recall Faucet](/intro/faucet) and request some tokens to be sent to your address.
These are used to purchase credits.

**You must own tokens** to create an agent memory store, and **you must purchase and use credits**
to store your agent's data (e.g., CoT logs).

The CLI allows you to [purchase credits](/tools/cli/account#buy-credit) for your agent to use, or
purchase credit for your personal account and [delegate access](/tools/cli/account#approve-credit)
to your agent's wallet. Alternatively, you can [review the Portal guide](/intro/portal) on how to do
this in a web interface.
...
Optionally, you can configure the sync interval and batch size, which dictates how CoT logs are
written to Recall:
