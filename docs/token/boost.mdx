...
<Callout type="warn">
  This guide assumes that you have [staked RECALL token](/token/stake). If you don't have any RECALL
...
<Steps>
  ...
  <Callout type="info">
    Zero available Boost? Follow the [RECALL staking guide](/token/stake) to get your first boost.
  </Callout>
  <Step>
