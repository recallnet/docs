...
In its current state, data on Recall is not private. If do you have private data, **be sure to
encrypt it** before storing it. In the future, we're looking to incorporate different types of
access control to help with _both_ a read and write access patterns.
